...
export default function SeriesPage() {
  ...
  const progressList = getProgressList().filter(a => a.status === 'watching' && a.type.toLowerCase() === 'series');
    ...
    <div className="flex flex-col gap-8 mt-8 pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        >
          ...
          <p className="text-muted-foreground mt-2 font-medium">Manage your active series</p>
        </motion.div>
